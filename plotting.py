...
import os
import numpy as np # For np.zeros if needed for profile consistency logic
#画图
...
def plot_results(time_data, temperatures, chiller_log, ac_power_log, cabin_cool_power_log, # Added cabin_cool_power_log
    ...
    heat_gen_profiles: dict with 'motor', 'inv', 'batt'
    battery_power_profiles: dict with 'inv_in', 'comp_elec', 'total_elec'
    sim_params: dict containing various simulation parameters like T_ambient, targets, etc.
    """
